        ...
        var GridItemsControl = (function (_super) {
            ...
            function GridItemsControl() {
                ...
                this._ToggleEditCommand = new Fayde.MVVM.RelayCommand(function (args) {
                    return _this.EditingItem = (_this.EditingItem === args.parameter) ? undefined : args.parameter;
                });
            ...
            GridItemsControl.prototype.OnItemsSourceChanged = function (oldItemsSource, newItemsSource) {
                ...
                if (newItemsSource)
                    this._AddItems(0, Experimental.EnumerableEx.ToArray(newItemsSource));
...
(function (Fayde) {
    (function (Experimental) {
        ...
        var GridTemplateColumn = (function (_super) {
            ...
            GridTemplateColumn.DisplayTemplateProperty = DependencyProperty.Register("DisplayTemplate", function () {
                return Fayde.DataTemplate;
            }, GridTemplateColumn);
...
(function (Fayde) {
    (function (Experimental) {
        (function (EnumerableEx) {
            ...
            EnumerableEx.ToArray = ToArray;
        })(Experimental.EnumerableEx || (Experimental.EnumerableEx = {}));
        var EnumerableEx = Experimental.EnumerableEx;
    })(Fayde.Experimental || (Fayde.Experimental = {}));
    var Experimental = Fayde.Experimental;
})(Fayde || (Fayde = {}));
