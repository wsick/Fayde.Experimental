...
declare module Fayde.Experimental {
    class GridInputCell extends GridCell {
        ...
        public OnDisplayPropertyChanged(oldProperty: string, newProperty: string): void;
        public OnEditPropertyChanged(oldProperty: string, newProperty: string): void;
        ...
        private _Editor;
        public OnApplyTemplate(): void;
        public UpdateDisplayMember(): void;
    }
}
declare module Fayde.Experimental {
...
declare module Fayde.Experimental {
    class GridDateColumn extends GridInputColumn {
        public GetContainerForCell(item: any): GridDateCell;
    }
}
declare module Fayde.Experimental {
    class GridNumericColumn extends GridInputColumn {
        public GetContainerForCell(item: any): GridNumericCell;
    }
}
declare module Fayde.Experimental {
...
declare module Fayde.Experimental {
    module EnumerableEx {
        function ToArray<T>(en: IEnumerable<T>): T[];
    }
}
